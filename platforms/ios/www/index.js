...
app.wikitudePlugin.setOnUrlInvokeCallback(app.onURLInvoked);
	...
	onDeviceSupported: function() {
        ...
        app.wikitudePlugin._onARchitectWorldFailedLaunchingCallback = app.WorldFail;


     app.wikitudePlugin.setOnUrlInvokeCallback(app.onURLInvoked);
        // load an ARchitect World
        app.wikitudePlugin.loadARchitectWorld("www//views/theWorld.html"); // load an ARchitect World from the application bundle
...
//			window.navigate("views/truss.html");
			window.location.href ="views/truss.html";
		 //}
		 //else
		 //{
		 //nextPage;
