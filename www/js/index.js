...
var app = {
    ...
    initialize: function() {
//        this.bindEvents();
	var txtPitch = document.getElementById("pitch")
		txtPitch.value = localStorage.getItem("pitch");
//		alert("trying");
    },
    ...
    onDeviceSupportedCallback: function() {
        ...
        app.wikitudePlugin.loadARchitectWorld("assets/www/views/angleView/angleView.html");
    },
